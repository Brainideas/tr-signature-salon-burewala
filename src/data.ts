...
export const SERVICES: Service[] = [
  // Hair Services
  {
    ...
    category: 'Hair',
    description: 'Expert personalized haircuts, trimming, layer cuts, bob cuts, flick cuts, and professional style consulting tailored to your facial structure.',
  },
  {
    id: 'hairwash',
  ...
  },
  {
    ...
    category: 'Hair',
    description: 'Full hair transformation with premium, ammonia-free hair colors, beautiful highlights, streaks, lowlights, or hand-painted balayage/ombre for rich dimensions.',
  },
  {
    id: 'keratin',
    name: 'Keratin & Nanoplastia Hair Treatments',
    category: 'Hair',
    description: 'Pro Keratin and premium Nanoplastia treatments to eliminate frizz, restore hair structure, and deliver long-lasting, silky-smooth, glossy hair.',
  },
  ...
  // Skincare Services
  {
    ...
    category: 'Skincare',
    description: 'Multi-step advanced non-invasive skin treatment combining deep cleansing, exfoliation, extraction, hydration, and antioxidant protection using specialized tools.',
  },
  {
    id: 'dermacos',
  ...
  },
  {
    ...
    category: 'Skincare',
    description: 'Specially formulated brightening facial that helps reduce hyperpigmentation, uneven skin tone, and dullness, revealing a fresh and radiant glow.',
  },
  {
    id: 'acne-treatment',
    name: 'Acne Treatment',
  ...
  // Nails & Spa
  {
    ...
    category: 'Nails & Spa',
    description: 'Luxurious pampering for your hands and feet. Includes nail clipping, shaping, cuticle care, scrub exfoliation, soothing hand & foot massages, and detailed cleaning.',
  },
  {
    id: 'polisher',
  ...
  // Makeup & Laser
  {
    ...
    description: 'Our signature bridal makeup designed to make you look breathtakingly beautiful, radiant, and timeless on your special day. Highly customized.',
  },
  {
    id: 'party-makeup',
    name: 'Party Makeup',
  ...
  },
  {
    ...
    category: 'Makeup & Laser',
    description: 'Safe and state-of-the-art permanent hair reduction for facial hair. Gentle, effective, and performed with precise cooling technology for maximum comfort.',
  }
];
